 $(document).ready(function () {
        ...
        }).error(function(data, b) { console.log("json parse error, search function temporarily unavailable, please check the article title, to ensure that does not contain special symbols such as line breaks"); });
